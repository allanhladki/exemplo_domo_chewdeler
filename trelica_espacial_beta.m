% Programa MEF - TRELIÇA PLANA NÃO LINEAR

% IMPLEMENTACAO TESTE ALGORITMO FINAL - TRELIÇAS PLANAS
...
GDL = 3*NNOS;                           % Número de graus de liberdade do problema
...
if plotar_t_d == 1
    figure(2); % Gráfico tensão x deformação
