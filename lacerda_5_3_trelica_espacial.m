...
nmax = 450;                  % Número máximo de incrementos; 
...
DELTA_L_MAX = 0.15;            % Maior valor possível para o comprimento de arco;
...
GDL_trajetoria = 36;       % Grau de liberdade acompanhado na trajetória de equilibrio gráfica;
