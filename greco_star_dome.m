...
nmax = 700;                  % Número máximo de incrementos; 
imax = 10;                  % Número máximo de iterações;
TOL = 1e-4;                % Tolerância da convergência;
LAMBDA = 0;                 % Fator de carga (SOMENTO PARA O MÉTODO DO COMP. DE ARCO);
DELTA_L = 0.001;             % Comprimento de arco inicial (SOMENTE PARA O MÉTODO DO COMP. DE ARCO);     
...
DELTA_L_MAX = 0.01;            % Maior valor possível para o comprimento de arco;
DELTA_L_MIN = 0.001;         % Menor valor possível para o comprimento de arco; 
...
plotar_deformada = 2;       % Plotagem da treliça na configuração deformada (1 -> PLOTAR ¨¨¨¨¨ 0 -> NÃO PLOTAR);
...
GDL_trajetoria = 39;       % Grau de liberdade acompanhado na trajetória de equilibrio gráfica;
